package top.hanjie.common.handler.msg;
...
public abstract class AbstractMsgHandler {
    ...
    @PostConstruct
    public void init() {
        HANDLERS.putAll(SpringContextUtils.getBeans(AbstractMsgHandler.class));
    }
     ...
     * @param lg   语种
     * @return top.hanjie.common.handler.msg.AbstractMsgHandler
     */
