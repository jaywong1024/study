...
import io.github.jaywong1024.filter.JwtAuthenticationFilter;
import io.github.jaywong1024.handler.RestAuthenticationHandler;
import io.github.jaywong1024.handler.RestfulAccessDeniedHandler;
import io.github.jaywong1024.voter.PermissionVoter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/test/whatever").permitAll()
                // 其他请求都需要认证后才能访问
     ...
     * @return io.github.jaywong1024.filter.JwtAuthenticationFilter
     */
    @Bean
     ...
     * 权限不足异常处理类
     * @author 黄汉杰
     * @date 2022/4/21 0021 17:50
     * @return io.github.jaywong1024.handler.RestfulAccessDeniedHandler
     */
    @Bean
     ...
     * 用户未登录异常处理类.
     * @author 黄汉杰
     * @date 2022/4/21 0021 17:52
     * @return io.github.jaywong1024.handler.RestAuthenticationHandler
     */
    @Bean
    public RestAuthenticationHandler restAuthenticationEntryPoint() {
